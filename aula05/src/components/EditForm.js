...
function EditForm( {contato} ) {
  ...
  return (
    <div className="modal fade" id="editModal" tabIndex="-1" aria-labelledby="contatoModalLabel"
         aria-hidden="true">
            ...
            <form>
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="contato-nome" name="nome"
                       onChange={handleChange} value={contato.nome} />
              </div>
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="contato-telefone" name="telefone"
                       onChange={handleChange} value={contato.telefone} />
              </div>
